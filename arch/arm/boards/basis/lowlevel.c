 ...
 *
 * Modified lowlevel.c, original copyright follows:
 *
...
#define ESDCTL0_VAL (ESDCTL0_SDE | ESDCTL0_ROW13 | ESDCTL0_COL9)
...
void __bare_init __naked barebox_arm_reset_vector(void)
{
	...
	arm_setup_stack(MX27_IRAM_BASE_ADDR + MX27_IRAM_SIZE - 4);
	...
	/* Initial reset */
	writel(0x80000000, MX27_ESDCTL_BASE_ADDR + IMX_ESDMISC);
	writel(0x0079e729, MX27_ESDCTL_BASE_ADDR + IMX_ESDCFG0);
