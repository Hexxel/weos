...
/* MPLL should provide a 414.9 MHz clock from the 26 MHz reference */
#define MPCTL0_VAL (IMX_PLL_PD(0) |	\
		IMX_PLL_MFD(47) |	\
		IMX_PLL_MFI(7) |	\
		IMX_PLL_MFN(47))

/* SPLL should provide a 249.6 MHz clock from the 26 MHz reference */
