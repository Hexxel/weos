...
extern const struct coreclk_soc_desc msys_coreclks;
extern const struct clk_gating_soc_desc msys_gating_desc[];
#else
static const u32 msys_coreclks;
static const u32 msys_gating_desc;
#endif
